...
#define Ob_(x) (x & 1 | x >> 2 & 2 | x >> 4 & 4 | x >> 6 & 8 |		\
	x >> 8 & 16 | x >> 10 & 32 | x >> 12 & 64 | x >> 14 & 128 | x >> 16 & 256)
...
#define ifError(is,_fmt, ...)  if(!is){DEBUGPRINT2(WHERESTR _fmt, WHEREARG, __VA_ARGS__);}

#define ifErrors(is,_fmt)  if(!is){DEBUGPRINT2(WHERESTR _fmt, WHEREARG);}
